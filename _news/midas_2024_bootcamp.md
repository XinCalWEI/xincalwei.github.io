...
**October 2024**
**2024 MIDAS Postdoctoral Fellowship Programs Orientation & AI Bootcamp**

---

The Michigan Institute for Data & AI in Society (MIDAS) hosted the 2024 MIDAS Postdoctoral Fellowship Programs Orientation & AI Bootcamp. AIDD Lab members actively participated in the event and presented their research in the poster session.
...
[Read more about the event](https://disasterdata.engin.umich.edu/news/midas-orientation)

---

<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/midas_2024_bootcamp.jpg" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    Photo (left to right): Simone Curtis, Major Zeng, Sabine Loos, Christin Salley, Xin Wei
</div>
