...
_A preliminary version of this work was selected for an oral presentation at **AGU Fall Meeting 2025 (AGU25)** and was featured as a **Highlighted Talk** ([link](https://agu.confex.com/agu/agu25/meetingapp.cgi/Paper/1938874))._
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/projects/usgs-landslide-factsheet.jpg" class="img-fluid rounded z-depth-1" alt="USGS National Landslide Susceptibility Map factsheet" %}
    </div>
</div>
<div class="caption">
    The USGS National Landslide Susceptibility Map. This project builds on the national landslide damage and loss dataset compiled by the USGS. (Image: U.S. Geological Survey)
</div>

---

**Team:** Xin Wei, Vaibhav Balloli, Lauren Palermo, Benjamin Mirus, Nathan J. Wood, Alice Pennaz, Aleeza Wilkins, Elizabeth Bondi-Kelly, and Sabine Loos

**Partner:** U.S. Geological Survey (USGS) · **Duration:** 2024 – Present
